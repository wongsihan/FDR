...
class CNNEncoder1d(nn.Module):
    ...
    def __init__(self, feature_dim,ratio,anchor = False,output = None):
        ...
        self.fc1 = nn.Conv1d(64, 64 // ratio, kernel_size=1,
                             padding=0)
        self.relu = nn.ReLU(inplace=True)
        self.fc2 = nn.Conv1d(64 // ratio, 64, kernel_size=1,
                             padding=0)
    ...
    def forward(self, x):
       ...
       # out = self.layer1(x)
        ...
        # out = out.view(out.size(0),-1)
        return out,x_IN,x_useful,x_useless  # 64
